...
class Application extends Container implements HttpKernelInterface, ResponsePreparerInterface
{
    ...
    {
        return 'D:\\phpweb\\yxd_minbbs\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation' . '/start.php';
    }
    ...
    public function handle($level, $message, $file = 'unknown', $line = 0, $context = array())
    {
        ...
        if ($this->displayErrors && error_reporting() & $level && $this->level & $level) {
            if (!class_exists('Symfony\\Component\\Debug\\Exception\\ContextErrorException')) {
                require 'D:\\phpweb\\yxd_minbbs\\vendor\\symfony\\debug\\Symfony\\Component\\Debug' . '/Exception/ContextErrorException.php';
            }
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = 'D:\\phpweb\\yxd_minbbs\\vendor\\filp\\whoops\\src\\Whoops\\Handler' . '/../Resources';
        }
